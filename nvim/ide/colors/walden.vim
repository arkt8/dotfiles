...
hi Statement ctermbg=NONE ctermfg=4
...
hi VertSplit ctermbg=NONE ctermfg=1 cterm=NONE
...
hi ALEWarningSign ctermbg=2 ctermfg=15
hi ALEError ctermbg=1 ctermfg=15 cterm=underline guisp=15
hi ALEWarning ctermbg=2 ctermfg=15 cterm=underline guisp=15
