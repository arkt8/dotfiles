...
let s:colors.base0 = { 'gui': '#091f2e', 'cterm': 0 }
let s:colors.base1 = { 'gui': '#0a3749', 'cterm': 8 }
let s:colors.base2 = { 'gui': '#245361', 'cterm': 10 }
let s:colors.base3 = { 'gui': '#4e5166', 'cterm': 12 }
let s:colors.base4 = { 'gui': '#599cab', 'cterm': 11 }
let s:colors.base5 = { 'gui': '#99d1ce', 'cterm': 14 }
let s:colors.base6 = { 'gui': '#d3ebe9', 'cterm': 7 }
let s:colors.base7 = { 'gui': '#ffffff', 'cterm': 15 }
" Other colors.
let s:colors.red     = { 'gui': '#ff4033', 'cterm': 1  }
let s:colors.orange  = { 'gui': '#ff9c26', 'cterm': 9  }
let s:colors.yellow  = { 'gui': '#ffb31b', 'cterm': 3  }
let s:colors.magenta = { 'gui': '#9ba2cd', 'cterm': 13 }
let s:colors.violet  = { 'gui': '#656984', 'cterm': 5  }
let s:colors.blue    = { 'gui': '#1f697f', 'cterm': 4  }
let s:colors.cyan    = { 'gui': '#33859E', 'cterm': 6  }
let s:colors.green   = { 'gui': '#00d29e', 'cterm': 2  }
