...
let s:colors.dark_orange  = { 'gui': '#d26937', 'cterm': 9  }
let s:colors.dark_yellow  = { 'gui': '#edb443', 'cterm': 3  }
let s:colors.dark_magenta = { 'gui': '#888ca6', 'cterm': 13 }
let s:colors.dark_violet  = { 'gui': '#4e5166', 'cterm': 5  }
let s:colors.dark_blue    = { 'gui': '#195466', 'cterm': 4  }
let s:colors.dark_cyan    = { 'gui': '#33859E', 'cterm': 6  }
